...
import { ClipAuthor } from './anims/author.mjs'
import { AUTHORED } from './anims/clips/index.mjs'
...
// in the order written: a spec may build on any clip above it
const made = new ClipAuthor(library.document).author(AUTHORED)
