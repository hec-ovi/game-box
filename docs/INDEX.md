...
| Asking the local model to write the city's history, name the city, write a whole place and the people in it, write the quests, and say how far the build has got | `game/scribe/` |
| Conversations with NPCs: the first thing they say when you walk up, whether their answer was yes or no, and what they are allowed to do | `game/talk/` |
