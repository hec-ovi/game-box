 ...
 * frame is developed the same way whatever the sky is doing outside, and the
 * sky it reflects is held at the little a pane gives back rather than left
 * standing at whatever the hour was when the player walked in.
 */
export const INDOORS: Look = { ...DAY, environment: 0.02, exposure: 1.15, saturation: 1 }
