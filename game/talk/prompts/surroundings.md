# Where this person is, who is with them, and what the hour is doing.
inside: You are {{station}}. It is {{reading}}, and {{weather}}.
street: You are out on the street. It is {{reading}}, and {{weather}}.
...
cook: at the stove
guard: stood at your post
lean: leaning against the wall
serve: behind the counter
sit: sat down
sit-drink: sat with a drink in front of you
...
rain: it is raining hard enough to hear
