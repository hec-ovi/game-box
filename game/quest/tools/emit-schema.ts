...
import { questSheetContract } from '../src/beats.ts'
import { questDraftContract } from '../src/draft.ts'
...
for (const published of [questContract, questDraftContract, questSheetContract, gameEventContract, questProgressContract]) {
