...
| Pedestrians walking the streets: where each is going, keeping out of the cars, who walks with the player, and when a conversation on the pavement is over | `game/crowd/` |
